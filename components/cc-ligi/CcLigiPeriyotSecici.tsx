...
//
// CC Ligi periyot kontrolü. Üç dropdown:
//   - Periyot (Aylık / Dönemlik / Yıllık)
//   - Periyota göre dinamik ikinci dropdown (ay / çeyrek / —)
//   - Yıl
//
// Mobil dikey: gizli (sabit Bu Ay), masaüstü + mobil yatay: görünür.
...
export default function CcLigiPeriyotSecici({
  ...
  return (
    <div
      className="cc-ligi-periyot-secici flex gap-2 mb-4 items-center flex-wrap"
