...
- **KOMPLEKS FAZ (baseline'daki 18 dosya, tek tek):**
  ...
  - ⬜ K4 Profil (2) · K5 Video görünürlük (1) · K6 Hedef listeleri (3, hedef ekseni → `TUM_HEDEF_ROLLER`) · **K7 Kullanıcılar (1) — KARAR** (dropdown'da İK+admin eksik, kasıt mı sapma mı?).
