...
## Kalite taraması frenleri
- **Q0 kuralı — SIFIR DEĞİŞİKLİK:** Tarama aşamasında hiçbir dosya değiştirilmez, hiçbir DB yazımı yapılmaz.
...
## Kaynaklar
- Proje bilgisi: docs/ altındaki belgeler. Kararlar oradadır, yeniden sorgulama.
