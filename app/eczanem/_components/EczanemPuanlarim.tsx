...
interface PuanEczanesi { eczane_id: string; eczane_adi: string; pasife_kalan_gun?: number | null; urunler: PuanUrunu[]; }
interface KullanilanPuan { siparis_id: string; eczane_adi: string; urun_adi: string; barkod: string | null; kullanilan_puan: number; indirim_tl: number; satis_fiyati: number | null; indirimli_fiyat: number | null; islem_kodu: string | null; onay_tarihi: string; }
