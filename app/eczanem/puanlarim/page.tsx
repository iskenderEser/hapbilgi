...
export default function EczanemPuanlarimPage() {
  ...
  return <div className="min-h-screen bg-[#f5f8fb] pb-12" style={{ fontFamily: "'Nunito', sans-serif" }}>
    ...
    <EczanemMusteriNavbar ad={kullanici.adSoyad || kullanici.ad || "Müşteri"} telefon={kullanici.telefon} onCikis={cikisYap} onYenile={() => setYenilemeAnahtari((deger) => deger + 1)} yenileniyor={yenileniyor} />
