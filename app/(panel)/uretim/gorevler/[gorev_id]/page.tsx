...
export default function UretimGorevDetayPage() {
  ...
  const videoTeslimEt = async () => {
    ...
    if (teslimSonucu === "tamamlandi") {
      ...
      // Encode arka planda devam eder; kullanıcı beklemeden iş listesine dönebilir.
      setYuklenenVideo(null);
