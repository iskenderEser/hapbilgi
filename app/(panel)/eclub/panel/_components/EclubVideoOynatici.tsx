  ...
  const handleBitir = async () => {
    ...
    try {
      ...
      if (!d.soru_gosterilecek && d.soru_hakki_nedeni === "ileri_sarma") {
        uyari("Öğrenme içeriğinde ileri gidildiği için bu tamamlama sonunda sorular gösterilmeyecek.");
      }
