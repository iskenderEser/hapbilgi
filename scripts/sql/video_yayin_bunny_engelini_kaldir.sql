-- Video yayınını Bunny'nin anlık işleme/metadata durumuna bağlayan ortak DB
-- kapısını kaldırır. Podcast, dijital broşür ve literatür doğrulama kapıları korunur.
...
BEGIN
  ...
  -- Video yayınları legacy video onay akışından geçer. Bunny encode/metadata
  -- tamamlanması yayın komutunu engellemez; tüketici görünürlüğü ayrıca süzülür.
...
SELECT true AS video_yayin_bunny_engeli_kaldirildi;
