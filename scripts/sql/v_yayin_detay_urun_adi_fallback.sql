...
--
-- TEK DEĞİŞİKLİK: u.urun_adi → COALESCE(u.urun_adi, t.urun_adi); t.urun_adi
-- GROUP BY'a eklendi. Diğer tüm alanlar ve join'ler aynen korunmuştur.
--
...
CREATE OR REPLACE VIEW public.v_yayin_detay AS
 SELECT ym.yayin_id,
  ...
  GROUP BY ym.yayin_id, ym.soru_seti_durum_id, ym.durum, ym.yayin_tarihi, ym.durdurma_tarihi,
    ...
    t.icerik_turu, t.hedef_rol, t.talep_no, f.firma_adi;
