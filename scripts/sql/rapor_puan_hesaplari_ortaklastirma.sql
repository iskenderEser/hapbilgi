...
sayilar AS (
  SELECT
    ...
    (SELECT COUNT(*) FROM scope_yayinlari WHERE yayin_tarihi >= p_baslangic AND yayin_tarihi <= p_bitis)::int AS donem_yayin,
    (SELECT COUNT(*) FROM scope_yayinlari WHERE durum = 'yayinda')::int AS canli,
    (SELECT COUNT(*) FROM scope_yayinlari WHERE yayin_tarihi >= p_baslangic AND yayin_tarihi <= p_bitis AND icerik_turu = 'urun')::int AS urun,
    (SELECT COUNT(*) FROM scope_yayinlari WHERE yayin_tarihi >= p_baslangic AND yayin_tarihi <= p_bitis AND icerik_turu = 'egitim')::int AS egitim,
    (SELECT COUNT(*) FROM scope_yayinlari WHERE yayin_tarihi >= p_baslangic AND yayin_tarihi <= p_bitis AND icerik_turu IN ('medikal','urun_medikal'))::int AS medikal,
    (SELECT COUNT(*) FROM scope_yayinlari WHERE yayin_tarihi >= p_baslangic AND yayin_tarihi <= p_bitis AND icerik_turu = 'ik')::int AS ik,
    (SELECT COUNT(*) FROM scope_yayinlari WHERE yayin_tarihi >= p_baslangic AND yayin_tarihi <= p_bitis AND hazir_video = false AND hazir_soru_seti = false)::int AS normal,
    (SELECT COUNT(*) FROM scope_yayinlari WHERE yayin_tarihi >= p_baslangic AND yayin_tarihi <= p_bitis AND hazir_video = true AND hazir_soru_seti = false)::int AS hazir_video,
    (SELECT COUNT(*) FROM scope_yayinlari WHERE yayin_tarihi >= p_baslangic AND yayin_tarihi <= p_bitis AND hazir_video = false AND hazir_soru_seti = true)::int AS hazir_set,
    (SELECT COUNT(*) FROM scope_yayinlari WHERE yayin_tarihi >= p_baslangic AND yayin_tarihi <= p_bitis AND hazir_video = true AND hazir_soru_seti = true)::int AS hazir_ikisi,
