-- scripts/sql/get_analiz_yonetici_tuketim.sql
--
-- Analiz sayfası — yönetici kolu tüketim metrikleri (tüm firma kapsamı).
--
-- GÜNCELLEME (05.08.2026 — künye geçişi): BM, TM ve üretici kollarındaki
...
BEGIN
  SELECT k.firma_id INTO v_firma_id
  FROM kullanicilar k
  ...
  -- KAYIP 5: izlenmeyen video (CROSS JOIN + NOT EXISTS)
