-- scripts/sql/v_yayin_detay_firma_id.sql
--
-- Firma geneli (takımsız) içeriğin kapsanabilmesi için firma_id ekleme
-- (İskender 24.07.2026).
-- Medikal/eğitim "tüm firma" içeriği takim_id = NULL ile üretiliyor. Yayındaki
-- Videolar kapsamı yalnız takım bazlıydı → takımsız içerik eleniyordu (Medikal
